...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const handleMediaChange = (e) => {
        if (e.matches) {
            ...
            swiper.changeDirection('vertical'); // Меняем направление слайдера на вертикальное
        } else {
            ...
            swiper.changeDirection('horizontal'); // Меняем направление слайдера на горизонтальное
        }
    };
    ...
    const handleWheelScroll = (event) => {
        if (isScrollLocked && !isProcessingScroll) {
            ...
            }, 100); // Выберите задержку в зависимости от ваших нужд
        }
    };
    ...
    swiper = new Swiper('.swiper', {
        ...
        direction: 'horizontal', // Начальное направление
        loop: false,
        speed: 800,
        effect: 'cube',
        shadow: false,
